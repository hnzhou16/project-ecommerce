// TODO: change NODE_ENV before deploy
export const serverAPI = process.env.REACT_APP_NODE_ENV === "production" ? process.env.REACT_APP_DOMAIN_SERVER : process.env.REACT_APP_LOCAL_SERVER
